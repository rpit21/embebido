    	                ...
    	                float ax_cal, ay_cal, az_cal, gx_cal, gy_cal, gz_cal;
    	                           while(ros::ok()) {
    	                               ...
    	                               mpu.GetAccelFloat(&accel_x, &accel_y, &accel_z);
										...
										//ax_cal = accel_x*acc_x_m*2.2 + acc_x_b/3 + 1.42;//*2.2 + /3
										//ay_cal = accel_y*acc_y_m*2.2 + acc_y_b/3 + 0.27;//*2.2 + /3
										//az_cal = accel_z*acc_z_m*2.2 + acc_z_b/3 - 0.51;//*2.2 + /3
										
                                        ax_cal = (accel_x + acc_x_b)*acc_x_m;
										ay_cal = (accel_y + acc_y_b)*acc_y_m;
										az_cal = (accel_z + acc_z_b)*acc_z_m;
