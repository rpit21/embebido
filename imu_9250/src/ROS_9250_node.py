...
import numpy as np
sys.path.append("/home/pi/ROSPI_WS/src/imu_9250/src")
t0 = time.time()
...
while time.time()-t0<5:
    try: 
        ...
        continue
acc_coefs  = np.load('/home/pi/ROSPI_WS/src/imu_9250/src/acc_coefs.npy') #m b
gyro_coefs = np.load('/home/pi/ROSPI_WS/src/imu_9250/src/gyro_coefs.npy')
